...
OUTPUT = (
    ...
    / "documents"
    / "archive"
    / "CV_LuongDucTrong_FrontendDeveloper_v4_vi_18082026.pdf"
)
...
story += [
    body(
        ...
        "phát triển full-stack cho web và mobile."
    )
]
...
story += [
    title_date(
        "Lập trình viên Frontend theo dự án | FTES Co., Ltd.",
        "04/2025 - Hiện tại",
    ),
    Paragraph("Làm việc từ xa", styles["context"]),
    Spacer(1, 3),
    body(
        "<b>Nền tảng học tập FunnyCode</b> - Nền tảng học trực tuyến tích hợp thương mại phục vụ đào tạo "
        "lập trình."
    ),
    body("Bản chạy thử: " + link("https://beta.funnycode.vn", "beta.funnycode.vn")),
    Spacer(1, 2),
    bullet("Phụ trách kiến trúc frontend và quá trình phát triển liên tục của ứng dụng đang vận hành."),
    bullet(
        "Phát triển và duy trì các luồng chính gồm khám phá và học khóa học, xác thực người dùng, lộ trình "
        "có AI hỗ trợ, tiến độ học tập và thương mại khóa học."
    ),
    bullet(
...
story += [
    ...
    Spacer(1, 14),
    title_date("Game 2048 | Phát triển độc lập", "11/2024 - 08/2026"),
    Paragraph("Dự án cá nhân", styles["context"]),
    Spacer(1, 3),
    body(
        "Bản chạy thử: "
        + link("https://ldt.is-a.dev/game-2048/", "ldt.is-a.dev/game-2048/")
    ),
    body(
        "Mã nguồn: "
        + link(
    ...
    Spacer(1, 2),
    bullet(
        "Xây dựng cơ chế điều khiển bằng bàn phím và cảm ứng, hoàn tác, lưu điểm cao cùng hiệu ứng khi "
        "thắng hoặc kết thúc trò chơi."
    ),
    bullet(
        "Thiết kế game engine TypeScript độc lập với framework và kết nối với React thông qua custom hooks "
        "cùng <font name='NotoSans'>useSyncExternalStore</font>."
    ),
    body("<b>Công nghệ:</b> React, TypeScript, Vite, Tailwind CSS, Framer Motion"),
]

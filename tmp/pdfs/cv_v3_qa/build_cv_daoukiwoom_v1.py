...
OUTPUT = (
    ...
    / "output"
    / "pdf"
    / "CV_LuongDucTrong_FrontendDeveloper_DaouKiwoom_07092026.pdf"
)
...
def decorate_page(canvas, doc) -> None:
    ...
    canvas.setKeywords(
        "Lượng Đức Trọng, Frontend Developer, React, Next.js, TypeScript, Ant Design"
    )
...
story += [
    body(
        ...
        "web applications using React, Next.js, and TypeScript. Skilled in reusable component design, "
        "enterprise and administration interfaces, REST API integration, client and server-data management, "
        "responsive implementation, and automated deployment. Comfortable taking ownership of existing "
        "codebases, solving frontend problems independently, and learning unfamiliar technologies."
    )
]
...
story += [
    ...
    bullet("<b>UI &amp; Components:</b> Tailwind CSS, shadcn/ui, Ant Design, SAP UI5 Web Components"),
    bullet("<b>State &amp; APIs:</b> TanStack Query, Zustand, REST APIs, Axios, SAP OData"),
    bullet("<b>Tools &amp; Platforms:</b> Git, GitHub Actions, Vite, pnpm, PostgreSQL, SQLite"),
]
...
story += [
    ...
    bullet(
        "Built reusable UI components, integrated REST APIs, and managed client-side state and server data "
        "with Zustand and TanStack Query."
    ),
    bullet(
        "Improved responsive interfaces and maintained existing codebases with a focus on usability, "
...
story += [
    ...
    Spacer(1, 3),
    body(
        "An enterprise-style administration application for managing SAP file attachments, business "
        "objects, users, configuration, and monitoring workflows."
    ),
    Spacer(1, 2),
    bullet(
    ...
    bullet(
        "Developed about 10 screens for data lists, attachment operations, user administration, "
    ...
    Spacer(1, 3),
    body(
        "A responsive portfolio for presenting selected projects, technical capabilities, and professional "
        "information."
    ),
    Spacer(1, 2),
    bullet(
        "Built reusable project case studies, responsive navigation, light and dark themes, reduced-motion "
        "support, and bilingual content."
    ),
    bullet(
        "Implemented a protected contact workflow, static generation, and automated GitHub Pages deployment."
    ),
    body(
        "<b>Technologies:</b> Nuxt, Vue.js, TypeScript, Tailwind CSS, @nuxtjs/i18n, "
        "Cloudflare Turnstile, GitHub Actions"
    ),
]

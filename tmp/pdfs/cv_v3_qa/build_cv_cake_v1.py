...
OUTPUT = (
    ...
    / "documents"
    / "archive"
    / "CV_LuongDucTrong_FrontendWebEngineer_Cake_27082026.pdf"
)
...
def decorate_page(canvas, doc) -> None:
    ...
    canvas.setTitle("Lượng Đức Trọng - Frontend Web Engineer")
    canvas.setSubject("Curriculum Vitae - Frontend Web Engineer")
    canvas.setKeywords(
        "Lượng Đức Trọng, Frontend Web Engineer, React, Next.js, TypeScript, web engineering"
    )
    ...
    canvas.drawString(LEFT, 26, "Luong Duc Trong - Frontend Web Engineer")
...
story = [
    ...
    Paragraph("Frontend Web Engineer", styles["role"]),
    Paragraph(
...
story += [
    body(
        "Frontend Developer with nearly 2 years of hands-on experience delivering production and "
        "enterprise web applications using React, Next.js, and TypeScript. Skilled in frontend "
        "architecture, reusable UI systems, server rendering, API integration, state and server-data "
        "management, and automated deployment. Comfortable taking ownership of an existing codebase, "
        "solving problems independently, and learning unfamiliar technologies. Seeking to grow through "
        "high-performance, large-scale web products and broader full-stack responsibilities."
    )
]
...
story += [
    ...
    Spacer(1, 3),
    bullet(
        "Designed, developed, and maintained frontend features across web products using React, Next.js, "
        "and TypeScript."
    ),
    bullet(
        "Built reusable UI components and structured client state, server data, and REST API integrations "
        "with Zustand and TanStack Query."
    ),
    bullet(
        "Investigated issues in existing codebases and delivered responsive, maintainable improvements "
        "with a strong focus on product usability."
    ),
    Spacer(1, 12),
...
story += [
    ...
    Spacer(1, 2),
    bullet(
        "Took over the existing frontend codebase and independently handled its day-to-day architecture, "
        "development, and maintenance."
    ),
    bullet(
        "Built and maintained core flows for course discovery and learning, authentication, AI-assisted "
        "roadmaps, learner progress, and course commerce."
    ),
    bullet(
        "Modernized the application with Next.js 16, React 19, and Partial Prerendering while organizing "
        "reusable UI, client state, and server-data layers with shadcn/ui, Zustand, and TanStack Query."
    ),
    body(
...
doc = SimpleDocTemplate(
    ...
    topMargin=51,
    bottomMargin=56,
    title="Lượng Đức Trọng - Frontend Web Engineer",
    author="Lượng Đức Trọng",
    subject="Curriculum Vitae - Frontend Web Engineer",

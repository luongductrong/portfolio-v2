...
OUTPUT = (
    ...
    / "documents"
    / "archive"
    / "CV_LuongDucTrong_JuniorFrontendEngineer_Nexlab_03092026.pdf"
)
...
def decorate_page(canvas, doc) -> None:
    ...
    canvas.setTitle("Lượng Đức Trọng - Junior Frontend Engineer")
    canvas.setSubject("Curriculum Vitae - Junior Frontend Engineer")
    canvas.setKeywords(
        "Lượng Đức Trọng, Junior Frontend Engineer, React, Next.js, TypeScript, AI coding agents"
    )
    ...
    canvas.drawString(LEFT, 26, "Luong Duc Trong - Junior Frontend Engineer")
...
story = [
    ...
    Paragraph("Junior Frontend Engineer", styles["role"]),
    Paragraph(
...
story += [
    body(
        ...
        "production web applications using React, Next.js, and TypeScript. Skilled in reusable UI systems, "
        "server rendering, REST API integration, client and server-data management, and automated deployment. "
        "Experienced in using AI coding agents, including Codex, Antigravity, and GitHub Copilot, to support "
        "implementation, code review, and testing. Comfortable taking ownership of an existing codebase, "
        "learning unfamiliar technologies, and delivering responsive, maintainable interfaces."
    )
]
...
story += [
    ...
    bullet("<b>AI Coding Agents:</b> Codex, Antigravity, GitHub Copilot"),
    bullet(
...
story += [
    ...
    bullet(
        "Used AI coding agents such as Codex to accelerate system development while maintaining code quality "
        "and consistency."
    ),
    Spacer(1, 12),
...
story += [
    ...
    bullet(
        ...
        "support, and semantic page structures."
    ),
    bullet(
...
doc = SimpleDocTemplate(
    ...
    topMargin=51,
    bottomMargin=56,
    title="Lượng Đức Trọng - Junior Frontend Engineer",
    author="Lượng Đức Trọng",
    subject="Curriculum Vitae - Junior Frontend Engineer",

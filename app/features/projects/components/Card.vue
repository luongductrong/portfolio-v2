...
<template>
  <Motion
    ...
    class="group h-full overflow-hidden rounded-lg border bg-card text-card-foreground transition-[border-color,box-shadow] duration-300 hover:border-primary/45 hover:shadow-lg hover:shadow-primary/5"
  >
    <NuxtLink
